...
<body class="bg-gray-900 text-white min-h-screen hero-bg">
                        ...
                        <form method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500" 
